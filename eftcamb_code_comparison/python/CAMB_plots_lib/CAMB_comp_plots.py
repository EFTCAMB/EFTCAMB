...
class CAMB_results_compare_plot:
    ...
    def __init__(self, root1, root2, outpath,
        ...
        # load the data:
        if os.path.isfile(root1+'_scalCls.dat'):
            self.scalCls_1           = np.loadtxt(root1+'_scalCls.dat')
        if os.path.isfile(root1+'_scalCovCls.dat'):
            self.scalCovCls_1        = np.loadtxt(root1+'_scalCovCls.dat')
        if os.path.isfile(root2+'_scalCls.dat'):
            self.scalCls_2           = np.loadtxt(root2+'_scalCls.dat')
        if os.path.isfile(root2+'_scalCovCls.dat'):
            self.scalCovCls_2        = np.loadtxt(root2+'_scalCovCls.dat')

        # check whether file exists:
        if not ( os.path.isfile(root1+'_lensedCls.dat') \
            and  os.path.isfile(root1+'_lenspotentialCls.dat') \
            and  os.path.isfile(root2+'_lensedCls.dat') \
            and  os.path.isfile(root2+'_lenspotentialCls.dat') ): self.lensing=False
        ...
        # check whether file exists:
        if not ( os.path.isfile(root1+'_matterpower.dat') \
            and  os.path.isfile(root1+'_transfer_out.dat') \
            and  os.path.isfile(root2+'_matterpower.dat') \
            and  os.path.isfile(root2+'_transfer_out.dat') ): self.transfer=False
        ...
        # check whether file exists:
        if not ( os.path.isfile(root1+'_tensCls.dat') \
            and  os.path.isfile(root1+'_totCls.dat') \
            and  os.path.isfile(root2+'_tensCls.dat') \
            and  os.path.isfile(root2+'_totCls.dat') ): self.tensor=False
