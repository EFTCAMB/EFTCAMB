! This module is based on a code written by George Benthien.
! This file is taken from http://gbenthien.net/strings/str-index.html
! We modified to remove some things that we do not need (for now...)
