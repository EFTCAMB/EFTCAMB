    ...
    !Modified by Nelson !Dummy variable to call H(a=1) and set it to CP%H0
    real(dl) :: Haux
    !Modified by Nelson 
    ...
    !Modified by Nelson
    real(dl) CAMB_GetAge, Haux
    !Modified by Nelson
    integer error

    !Modified by Nelson
    call  CAMBParams_Set(P, Haux, error, .false.)
    !Modified by Nelson
    if (error/=0) then
        CAMB_GetAge = -1
    else
    ...
    !Modified by Nelson
    call CAMBParams_Set(P,Haux, error)
    !Modified by Nelson
