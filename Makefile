...
FFLAGS = -qopenmp -O3 -W0 -WB -fpp -qopt-report=0 -ipo
# -xHOST -no-prec-div -fp-model fast=2 -fno-alias -parallel
...
DEBUGFLAGS = -cpp -fopenmp -g -fbounds-check -fbacktrace -ffree-line-length-none -fmax-errors=4 -ffpe-trap=invalid,overflow,zero -DDEBUG
MODOUT =  -J$(OUTPUT_DIR)
SMODOUT = -J$(DLL_DIR)
