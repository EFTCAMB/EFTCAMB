...
#
# Script that runs the profiler of EFTCAMB for all the parameters in the parameters folder
#
...
# start the script:
printf "${Green}********************************************\n"
printf "EFTCAMB EXAMPLES: running profiler\n"
printf "********************************************\n${Color_Off}"
...
if [ "$SUCCESS" = true ]; then
	    printf "${Green}********************************************\n"
		printf "EFTCAMB EXAMPLES: done profiling\n"
		printf "********************************************\n${Color_Off}"
else
	    printf "${Yellow}********************************************\n"
		printf "EFTCAMB EXAMPLES: done profiling\n"
