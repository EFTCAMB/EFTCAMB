...
#
# Script that runs EFTCAMB with all the parameters in the parameters folder
#
...
# start the script:
printf "${Green}********************************************\n"
printf "EFTCAMB EXAMPLES: creating spectra\n"
printf "********************************************\n${Color_Off}"
...
if [ "$SUCCESS" = true ]; then
	    printf "${Green}********************************************\n"
		printf "EFTCAMB EXAMPLES: done creating spectra\n"
		printf "********************************************\n${Color_Off}"
else
	    printf "${Yellow}********************************************\n"
		printf "EFTCAMB EXAMPLES: done creating spectra\n"
