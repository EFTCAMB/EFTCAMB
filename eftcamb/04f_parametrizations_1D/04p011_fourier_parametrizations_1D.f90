...
contains
    ...
    subroutine Fourier1DInitFunctionFromFile( self, Ini )
        ...
        self%order_cos = Ini_Read_Int_File( Ini, TRIM(self%name)//'_Fourier_order_cos', 0 )
        self%order_sin = Ini_Read_Int_File( Ini, TRIM(self%name)//'_Fourier_order_sin', 0 )
        self%min_a0    = Ini_Read_Logical_File( Ini, TRIM(self%name)//'_min_a0', .False.  )
        ! allocate:
