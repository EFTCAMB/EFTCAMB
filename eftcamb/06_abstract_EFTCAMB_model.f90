...
module EFTCAMB_abstract_model
    ...
    contains
        ...
        procedure :: compute_kinetic_gradient    => EFTCAMBModelComputeKineticGradient                    !< subroutine that computes the kinetic and gradient terms. For details refer to the numerical notes.
...
contains
    ...
    subroutine EFTCAMBModelComputeKineticGradient( self, a, eft_par_cache, eft_cache )
    ...
    end subroutine EFTCAMBModelComputeKineticGradient
