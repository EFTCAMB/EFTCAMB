    ...
    subroutine EFTCAMBPureEFTstdAllocateModelSelection( self )
        ...
        select case ( self%PureEFTmodelOmega )
            ...
            case(3)
                ...
                allocate( param_names_latex(self%PureEFTOmega%parameter_number) )
        ...
        select case ( self%PureEFTmodelGamma1 )
            ...
            case(3)
                ...
                allocate( param_names_latex(self%PureEFTGamma1%parameter_number) )
        ...
        select case ( self%PureEFTmodelGamma2 )
            ...
            case(3)
                ...
                allocate( param_names_latex(self%PureEFTGamma2%parameter_number) )
        ...
        select case ( self%PureEFTmodelGamma3 )
            ...
            case(3)
                ...
                allocate( param_names_latex(self%PureEFTGamma3%parameter_number) )
        ...
        if ( .not. self%PureEFTHorndeski ) then
            ...
            select case ( self%PureEFTmodelGamma4 )
                ...
                case(3)
                    ...
                    allocate( param_names_latex(self%PureEFTGamma4%parameter_number) )
            ...
            select case ( self%PureEFTmodelGamma5 )
                ...
                case(3)
                    ...
                    allocate( param_names_latex(self%PureEFTGamma5%parameter_number) )
            ...
            select case ( self%PureEFTmodelGamma6 )
                ...
                case(3)
                    ...
                    allocate( param_names_latex(self%PureEFTGamma6%parameter_number) )
